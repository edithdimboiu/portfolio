  ...
  return (
    ...
    >
      <aside className="justify-self-center md:justify-self-start">
        <p className="text-2lg">Copyright © ${new Date().getFullYear()} - All right reserved</p>
      </aside>
      <nav className="grid-flow-col  items-center justify-self-center md:justify-self-end">
        <Link href="https://linkedin.com/in/edith-dimboiu-1670b869" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" className="fill-current">
        ...
        <Link href="https://github.com/edithdimboiu" target="_blank" rel="noopener noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" className="fill-current">
