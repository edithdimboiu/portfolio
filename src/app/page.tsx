      ...
      <div className="hero-content">
        <div className="max-w-max	">
          ...
          <p className="py-6 text-l md:text-2xl tracking-wide">
            ...
            feel that it fits me like a glove. I am open to new challenges and opportunities.{" "}
            <Link className="text-primary" href="/projects">
              Here
            </Link>{" "}
            you can see some of my projects and if you find something catchy please feel free to contact/follow me on{" "}
